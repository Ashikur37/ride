    ...
    <link rel="stylesheet" href="{{URL:: asset('assets/vendor/fonts/circular-std/style.css')}}">
    ...
    <link rel="stylesheet" href="{{URL:: asset('ssets/vendor/charts/chartist-bundle/chartist.css')}}">
