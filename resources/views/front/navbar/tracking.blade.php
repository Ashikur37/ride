                            ...
                            <div class="col-md-5 pad-30 wow fadeInRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                <div class="prod-info white-clr">
                                    ...
                                    <ul>
                                        ...
                                        <li> <span class="title-2">Product Name:</span> <span class="fs-16">{{$tracking->product_type}}</span> </li>
                                       
                                        <li> <span class="title-2">Product id:</span> <span class="fs-16">{{$tracking->product_id}}</span> </li>
                                        <li> <span class="title-2">order date:</span> <span class="fs-16">{{$tracking->order_date}}</span> </li>
                                        <li> <span class="title-2">order status:</span> <span class="fs-16 theme-clr">{{$tracking->order_status}}</span> </li>
                                        <li> <span class="title-2">weight (kg):</span> <span class="fs-16">{{$tracking->weight}}</span> </li>
                                        <li> <span class="title-2">order type:</span> <span class="fs-16">{{$tracking->order_type}}</span> </li>
                                    </ul>
                        ...
                        <div class="progress-wrap">
                            ...
                            <div class="row progress-content upper-text">
                                <div class="col-md-3 col-xs-8 col-sm-2">
                                    ...
                                    <h2 class="title-1 no-margin">{{$tracking->starting_place}}</h2>
                                </div>
                                ...
                                <div class="col-md-4 col-xs-8 col-sm-4 text-center">
                                    ...
                                    <h2 class="title-1 no-margin">{{$tracking->order_status}}</h2>
                                </div>
                                ...
                                <div class="col-md-2 col-xs-8 col-sm-2 text-right">
                                    ...
                                    <h2 class="title-1 no-margin">{{$tracking->address}}</h2>
                                </div>
                            </div>
