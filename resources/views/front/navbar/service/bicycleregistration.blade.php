@extends('welcome')
@section('title','bicycleregistration')
@section('content')
...
<div class="form-row">
     ...
     <div class="form-group col-md-6">
          <label for="mobilenumber">Mobile Number</label>
            <input type="mobilenumber" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Enter your Mobile Number" maxlength="20">
     </div>
...
<div class="form-row">
      <div class="form-group col-md-6">
          <label for="license_document">File Document</label>
             <input type="file" class="form-control" id="file_document" name="file_document" placeholder="File Document" maxlength="20">
     </div>
</div>
