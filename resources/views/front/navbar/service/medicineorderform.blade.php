...
@section('content')
 ...
 @if(count($errors) > 0)
  ...
  @endif
                        ...
                        <form action="{{route('medicineinput')}}" method="post"  enctype="multipart/form-data" data-parsley-validate="">
                        {{csrf_field()}}

                            	<div class="form-group">
                            		<input type="text" name="product_type" id="product_type"  value="Medicine" readonly="" class="form-control">
                            	</div>
                            	...
                            	<div class="form-group">
                            		<input type="text" name="mobile" id="mobile" placeholder="Receiver's Mobile No" class="form-control">
                            	</div>
