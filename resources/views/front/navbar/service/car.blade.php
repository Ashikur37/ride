...
<script>
  ...
  function confirm(){
    window.location.href=`{{URL::to('/car/start-trip')}}?lat1=${pickupPoint.lat}&lon1=${pickupPoint.lng}&lat2=${destinationPoint.lat}&lon2=${destinationPoint.lng}`
  }
  function calcCrow() 
    {
  ...
  function updateDistance(){
    if(destinationPoint){
      document.getElementById("distance").innerHTML="Trip distance "+calcCrow()+" KM"+"<br/>Total Cost "+Math.floor(calcCrow()*30)+"TK"; 
    }
  }
