...
@section('content')
 ...
 @if(count($errors) > 0)
  ...
  @endif
                        ...
                        <form action="{{route('packageinput')}}" method="post"  enctype="multipart/form-data" data-parsley-validate="">
                        {{csrf_field()}}

                            	<div class="form-group">
                            		<input type="text" name="product_type" id="product_type"  value="Package" readonly="" class="form-control">
                            	</div>
