...
<center>
    ...
    <h4 id="to"></h4>
    <h4 id="distance"></h4>
    <a href="{{URL::to('/car/trip/confirm/'.$carTrip->id)}}" class="btn btn-success" style="color:#fff">Confirm Now</a>
    <a class="btn btn-danger" style="color:#fff" href="{{URL::to('/car/trip/cancel/'.$carTrip->id)}}">
      Cancel
  </a>
</center>
