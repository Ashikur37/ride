                    ...
                    <div class="theme-container container">               
                        <div class="row">
                            <div class="col-md-3 col-sm-6 footer-widget">
                             ...
                             <div class="col-md-3 col-sm-6 footer-widget">
                                <h2 class="title-1 fw-900">Contact</h2>
                                <ul>
                                    <li> <a href="#">+880 1624213417</a> </li>
                                    <li> <a href="#">+880 1865778069</a> </li>
                                    <li> <a href="#">shakil.ahmed.hub@gmail.com</a> </li>
                                    <li> <a href="#">mirraju0304@gmail.com</a> </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6 footer-widget">
                                ...
                                <ul>
                                    ...
                                    <li> <a href="{{url('payment')}}">payment method</a> </li>
                                </ul>
                            </div>
                    ...
                    <div class="theme-container container">               
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 text-right">
                                <p> Design and <span class="theme-clr fa fa-heart"></span>  by <a href="#" class="main-clr"> Shanto </a> & <a href="#" class="main-clr">   Raju </a> </p>
                            </div>
                        </div>
                    </div>
                </div>
